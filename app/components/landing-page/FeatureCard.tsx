export default function FeatureCard(props: any) {
  ...
  return (
    <div class={`group rounded-xl border border-gray-200 shadow-sm hover:shadow-lg p-6 bg-white transition-all duration-200 hover:border-[#3399FF]/20 hover:-translate-y-1 ${className ?? ''}`}>
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h3 class="text-lg font-semibold text-gray-900 group-hover:text-[#3399FF] transition-colors duration-200">{title}</h3>
