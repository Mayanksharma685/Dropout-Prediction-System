...
`
            ...
            <section class="bg-white rounded-xl border shadow-sm p-4">
              <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
                <h3 class="text-sm font-semibold text-slate-700">Recent Scores</h3>
                <div class="relative">
                  <input 
                    type="text" 
                    id="studentSearch" 
                    ...
                    oninput="filterTestScoresBySearch(this.value)"
                  />
            ...
            <script dangerouslySetInnerHTML={{
              __html: `
function filterTestScoresBySearch(searchValue) {
  ...
  if (visibleRows.length === 0 && searchTerm !== '') {
    if (!noResultsMsg) {
      ...
      noResultsMsg.innerHTML = 'No test scores found matching your search.';
