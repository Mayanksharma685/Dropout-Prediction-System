                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                      <div class="flex items-center justify-between">
                        <div>
                          ...
                          <p id="monthlyDisbursement" class="text-2xl font-bold text-orange-600">-</p>
                        </div>
                        <div class="p-3 bg-orange-100 rounded-full">
                          <span class="text-orange-600 text-xl">💳</span>
                        </div>
        ...
        <script dangerouslySetInnerHTML={{
          __html: `
            ...
            document.addEventListener('DOMContentLoaded', function() {
              console.log('Part-time fellowship page loaded, starting analytics...');
              loadAnalytics();
              loadFellowships();
            });
            ...
            async function loadAnalytics() {
              console.log('Loading part-time fellowship analytics...');
              
              try {
                const response = await fetch('/api/fellowship-analytics?type=Part Time');
                console.log('Part-time fellowship analytics response status:', response.status);
                ...
                console.log('Part-time fellowship analytics data:', analytics);
                ...
                console.log('Part-time fellowship analytics loaded successfully');
                
              } catch (error) {
                console.error('Part-time fellowship analytics loading failed:', error);
            ...
            // Chart creation functions (same as full-time)
                ...
                <div class="p-4 hover:bg-gray-50">
                  <div class="flex justify-between items-start">
                    <div class="flex-1">
                      ...
                      <p class="text-orange-600 font-medium">₹\${Number(fellowship.amount).toLocaleString('en-IN')} / month</p>
