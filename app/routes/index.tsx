    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-orange-50 text-gray-900">
      ...
      <main>
        ...
        <Section id="solution">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">MARGDARSHAN consolidates student data into one intelligent platform, enabling proactive intervention through AI-powered risk detection.</p>
          </div>
        ...
        <Section id="about" title="About the Project" subtitle="Built for PSID 25102 to reduce dropouts">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-4 text-gray-700">
              <p>
                MARGDARSHAN focuses on early detection of at-risk students by consolidating academic and administrative signals into a single, mentor-friendly dashboard. The goal is to intervene early, with clear reasons, and improve student outcomes.
              </p>
              <p>
      ...
      <footer className="border-t py-8 text-center text-sm text-gray-600">
        <div className="max-w-6xl mx-auto px-4">
          © {new Date().getFullYear()} MARGDARSHAN — Built for PSID 25102
        </div>
      </footer>
